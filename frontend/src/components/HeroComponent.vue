      ...
      <div class="container mx-auto max-w-screen-xl">
        <div class="flex flex-col md:flex-row justify-between items-center">
          <div class="md:w-1/2 text-left mb-4 md:mb-0">
            <!-- <h1 class="text-[#e1dca3] text-4xl md:text-6xl font-bold leading-tight mb-6"> -->
            <h1 class="text-slate-700 text-4xl md:text-6xl font-bold leading-tight mb-6">
              Brighton Piano Tuition
            </h1>
          ...
          <div class="">
            <img src="../assets/piano.svg" alt="Hero Image" class="w-[500px] " >
          </div>
        </div>
      </div>
    </div>
